...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Satistics Dashboard",style={'textAlign':'center','color'':'#503D36','font-size':24}),#Include style for title
...
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='output-container', component_property='chlidren'),
    [Input(component_id='dropdown-statisics', component_property='value'), Input(component_id='select-year', component_property='value')])


def update_output_container(selected_statistics, recession_data):
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        mas=data.groupby('Month')['Auomobile_Sales'].mean().reset_index()
